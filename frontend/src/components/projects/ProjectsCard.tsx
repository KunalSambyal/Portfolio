            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((tag) => (
                        <span
                            key={tag}
                            className="text-[10px] md:text-xs font-mono font-bold text-cyber-purple/90 bg-cyber-purple/5 border border-cyber-purple/20 px-2.5 py-0.5 rounded"
                        >
                            {tag}
                        </span>
                    ))}
